...
var ds=document.getElementById('ds2');if(ds)ds.innerHTML='<b style="color:var(--success)">已就绪</b> ('+Object.keys(d.dx2a||{}).length+'诊断 + '+Object.keys(d.px2a||{}).length+'手术)';
